...
class SpamFilterComponentTest extends TestCase {
    ...
    /**
     * @var SpamFilterComponent $component
     */
    ...
    public function testStartup() {
        ...
        $this->assertTrue(in_array($today_fieldname_1,     $this->controller->components()->Security->getConfig('unlockedFields')));
        $this->assertTrue(in_array($yesterday_fieldname_1, $this->controller->components()->Security->getConfig('unlockedFields')));

        /*
         * Startup using additional random Session salt
         */
        $this->component->setConfig('use_session_salt', true);
        $this->component->startup(new Event('Test'));
        ...
        $this->assertTrue(in_array($today_fieldname_2,     $this->controller->components()->Security->getConfig('unlockedFields')));
        $this->assertTrue(in_array($yesterday_fieldname_2, $this->controller->components()->Security->getConfig('unlockedFields')));
    }
    ...
    public function testRequestIsSpamWithTodayValue() {
        ...
        $this->controller->setRequest($this->request->withData($fieldname, $fieldname));
        $is_spam = $this->component->request_is_spam();
